    ...
    while srv._pending_task_results:
        ...
        reply = await srv._stream_llm_to_tts(
            ...
            system_prompt=(
                ...
                "ACTION CONFIRMATIONS (cancel/delete/remove/send/schedule "
                "results — typically a short 'Done', 'Cancelled', 'Removed' "
                "or one-line status): respond in ONE short sentence. Do NOT "
                "summarise the affected item's details, do NOT recap what got "
                "cancelled/sent/saved, do NOT comment on how much time was "
                "'saved'. The user already knows what they asked for. Good: "
                "'Yeah, cancelled.' / 'Done, removed it.' / 'Sent.' Bad: "
                "'About your cancelled recording session — it was at seven, "
                "ran for an hour, so you've saved an hour this evening.'\n\n"
